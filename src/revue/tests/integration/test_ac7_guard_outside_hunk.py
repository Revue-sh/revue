...
from revue.core.agent_loader import LoadedAgent, load_agent_definition
from revue.core.ai_client import CompletionResult, TokenUsage
from revue.core.models import FileChange
from revue.core.tools.read_file import ReadFileTool, ToolResult
    ...
    * ``complete_with_tools`` — treatment path; drives the real
    ...
    def complete_with_tools(
        ...
        *,
        ...
        from revue.core import tool_loop as _tl
...
def _maya_definition() -> Any:
    ...
    maya_md = (
        Path(__file__).resolve().parents[2] / "agents" / "maya.md"
    )
