...
@patch("revue.core.pr_description_adapter.get_bitbucket_pr_description")
...
@patch("revue.core.pr_description_adapter.get_github_pr_description")
...
@patch("revue.core.pr_description_adapter.get_gitlab_pr_description")
