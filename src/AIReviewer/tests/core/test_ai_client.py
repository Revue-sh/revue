...
from AIReviewer.core.ai_client import (
    AnthropicClient,
    AzureOpenAIClient,
    CustomGatewayClient,
    OpenAIClient,
...
@patch("AIReviewer.core.ai_client.anthropic.Anthropic")
...
@patch("AIReviewer.core.ai_client.openai.AzureOpenAI")
...
@patch("AIReviewer.core.ai_client.time.sleep", return_value=None)
