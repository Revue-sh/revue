...
from AIReviewer.core.sage_pipeline import run_sage_analysis, SageSummary
from AIReviewer.core.models import AIReview, CodeFix, FixabilityResult
from AIReviewer.core.vcs_adapter import DiffPosition
...
class TestRunSageAnalysis:
    ...
    def test_run_sage_all_fixable(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "AIReviewer.core.sage_pipeline.classify_finding", mock_classify
        )
        ...
        monkeypatch.setattr(
            "AIReviewer.core.sage_pipeline.generate_fix", mock_generate
        )
