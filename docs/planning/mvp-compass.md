...
**Last updated:** 2026-06-08 (REVUE-428 **Done** — combined install+activate command; Revue-sh distribution URL. **0 hard launch blockers.**) Forward-looking only — the full Done history and authoritative status live in **Jira**; run `/epic-progress REVUE-269` for the live tally.
...
**~74 done · 0 hard launch blockers · run `/epic-progress REVUE-269` for the live tally.**
