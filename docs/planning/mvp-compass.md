...
**Last updated:** 2026-06-04 — REVUE-397 merged (latest). The full per-ticket merge history lives in the **✅ Done** table below; this header tracks only the current state.
...
**Headline progress: 48 Done / 69 active (70%) — 0 hard launch blockers — 1 strongly-should remains** (only REVUE-361 [email deliverability] left; denominator 65→69 from the REVUE-397/398/399 follow-ups + REVUE-400. Per-ticket Done history is in the **✅ Done** table below.)

| Bucket | Count | Meaning |
|--------|------:|---------|
| ✅ Done | 48 | Shipped — full per-ticket list (with dates + descriptions) is in the **✅ Done** table near the bottom of this doc. |
| 🔵 In Code Review | 0 | — |
