...
from revue_core.comments.position_adapter import get_position_adapter, PositionStatus
...
from revue_core.core.display import SEVERITY_EMOJI_ALT
...
class Poster:
    ...
    def _post_per_issue(
        ...
        for fp in resolved_fps:
            ...
            from revue_core.comments.models import HunkState
    ...
    def _build_summary_body(
        ...
        from revue_core.comments.summary_builder import build_enhanced_summary
        try:
