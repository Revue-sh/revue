...
from revue_core.core.diff_parser import parse_diff
from revue_core.core.models import FileChange
from revue_core.core.vcs_adapter import DiffPosition
from .models import Platform
from revue_core.core.logging_channels import Log, log_comment_posted
...
class GitLabAdapter(PlatformAdapter):
    ...
    def _get_mr_version_shas(self, project_id: str, pr_number: int) -> tuple[str, str, str]:
        ...
        from revue_core.core.vcs_adapter import extract_gitlab_version_shas
