...
def _import_orchestration() -> "OrchestrationModules":
    ...
    try:
        ...
        from revue_core.core.cleo_router import route, assign_files_to_agents
...
class ReviewPipeline:
    ...
    def run(
        ...
        if pr_context is not None:
            from revue_core.core.reply_tracking import get_strategy
    ...
    def _build_consolidator(
        ...
        *,
        ...
        from revue_core.comments._verifier import VexVerifier, VexVerifyPostProcessor
