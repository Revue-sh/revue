...
from revue_core.core.sage_pipeline import run_sage_analysis, SageSummary
from revue_core.core.models import AIReview, CodeFix, FixabilityResult
...
class TestRunSageAnalysis:
    ...
    def test_run_sage_all_fixable(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "revue_core.core.sage_pipeline.classify_finding", mock_classify
        )
        ...
        monkeypatch.setattr(
            "revue_core.core.sage_pipeline.generate_fix", mock_generate
        )
