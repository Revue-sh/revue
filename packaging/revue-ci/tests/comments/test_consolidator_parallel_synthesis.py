...
from revue_core.comments.consolidator import Consolidator, ProximityAndCountGroupingStrategy
...
def test_pass_b_uses_thread_pool_executor():
    ...
    with patch("revue_core.comments.consolidator.ThreadPoolExecutor", wraps=ThreadPoolExecutor) as spy:
