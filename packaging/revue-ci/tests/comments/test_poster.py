...
from revue_core.comments.models import Platform, ConsolidatedFinding, Attribution
...
def test_post_deduplicates_open_prior():
    ...
    with patch("revue_core.comments.poster.gen_fingerprint", return_value="fp-open"):
...
def test_post_skips_resolved_prior_from_total_findings():
    ...
    with patch("revue_core.comments.poster.gen_fingerprint", return_value="fp-resolved"):
