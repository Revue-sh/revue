...
def test_three_state_schema_top_level_is_a_tagged_union() -> None:
    ...
    # Arrange
    from revue_core.core.finding_schema import THREE_STATE_SCHEMA
...
def test_findings_branch_carries_findings_array() -> None:
    ...
    # Arrange
    from revue_core.core.finding_schema import THREE_STATE_SCHEMA, FINDING_ITEM
    branches = THREE_STATE_SCHEMA.get("anyOf") or THREE_STATE_SCHEMA["oneOf"]
...
def test_error_branch_enumerates_codes() -> None:
    ...
    # Arrange
    from revue_core.core.finding_schema import THREE_STATE_SCHEMA, ERROR_CODES
    expected_codes = {
...
def test_output_config_for_three_state_returns_schema_wrapped() -> None:
    ...
    # Arrange
    from revue_core.core.finding_schema import (
...
def test_output_config_for_three_state_returns_fresh_dict() -> None:
    ...
    helper)."""
    # Arrange
    from revue_core.core.finding_schema import output_config_for_three_state
