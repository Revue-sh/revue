...
from revue_core.core.shared_analysis import (
    run_shared_analysis,
...
def test_run_shared_analysis_logs_warning_on_fallback():
    ...
    # Arrange / Act
    with patch("revue_core.core.shared_analysis.Log") as mock_log:
        result = run_shared_analysis([_fc("app.py")], _mock_client("not json"))
...
def test_wrong_schema_old_classification_format_returns_fallback(caplog):
    ...
    import logging
    with caplog.at_level(logging.WARNING, logger="revue_core.core.shared_analysis"):
...
def test_prompt_contains_mandatory_schema_language():
    ...
    from revue_core.core.shared_analysis import SHARED_ANALYSIS_PROMPT
