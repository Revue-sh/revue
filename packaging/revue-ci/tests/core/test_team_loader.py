...
from revue_core.core.team_loader import (
    TeamConfig,
    get_team_agents,
    load_all_teams,
    load_team,
...
# Path to the actual teams directory (lives in the installed revue_core package).
_TEAMS_DIR = Path(revue_core.__file__).parent / "teams"
...
class TestCleoRouterUsesYamlTeams:
    def test_registry_contains_yaml_teams(self) -> None:
        from revue_core.core.cleo_router import _TEAM_REGISTRY
    ...
    def test_yaml_team_wins_over_preset(self, tmp_path, monkeypatch) -> None:
        ...
        from revue_core.core import cleo_router, team_loader
