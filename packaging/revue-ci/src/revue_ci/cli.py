...
from revue_core.core.display import SEVERITY_EMOJI_ALT  # noqa: E402
from revue_core.core.logging_channels import Log  # noqa: F401, E402
from revue_core.core.log import RevueLogger  # noqa: E402
...
from revue_core.core.config_loader import (
    DEFAULT_REVUE_YML,
    load_config,
    validate_config,
)
...
from revue_core.core.diff_parser import filter_changes, parse_diff_file
...
from revue_core.core.agent_loader import filter_code_replacement
...
from revue_core.core.logging_utils import _Lazy
...
def _run_per_issue_dedup(
    ...
    from revue_core.core.vcs_adapter import DiffPosition, compute_gitlab_line_code
...
def _post_to_platform(
    ...
    from revue_core.comments.models import SummaryComment
...
def _build_hunk_tracker(adapter, dedup_store, config):
    ...
    from revue_core.comments.hunk_tracker import HunkTracker, NullHunkTracker, NovaSingleShotResolutionStrategy
